const otpTemplate = (otp) => {
    ...
    <body>
        <div class="container">
            ...
            <div class="body">
                <p>Dear User,</p>
                <p>Thank you for registering with <strong>StudyNotion</strong>. To complete your registration, please use the following OTP (One-Time Password) to verify your account:</p>
